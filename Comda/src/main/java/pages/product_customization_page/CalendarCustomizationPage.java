...
public class CalendarCustomizationPage extends BasePage {
    ...
    private final By TextAndImageOption = By.xpath("//li[@class = 'designTabs__item active']");
    ...
    private final By ChoseFile = By.xpath("//div[@class = 'input-box']//input[@class = 'product-custom-option product-custom-option-123532 ']");
